...
public class Client {
    ...
    public Client() {
        try {
            ...
            System.out.println("-------- 1 Iniciando comunicación con el area ----------");

            // Corrige la ruta del archivo utilizando barras diagonales dobles o barras diagonales normales
            File fileOrigen = new File("C:\\Client\\Ventocilla.txt");
            ...
            System.out.println("-------- 2 Finalizando comunicación con el area  --------");
            clientServer.close();
